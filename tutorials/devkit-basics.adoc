:title: SMART COSMOS Objects DevKit Basics Tutorial
...
This tutorial helps you get started with the SMART COSMOS Objects DevKit. We'll
...
To get started with the Objects DevKit refer to the link:getting-started.adoc[Getting Started^] guide.
...
link:https://documenter.getpostman.com/view/437937/smart-cosmos-objects-devkit-tutorial/2JvFAy[Postman SMART COSMOS Objects DevKit Tutorial^]
...
== Run the SMART COSMOS Objects DevKit Postman Collection

The
link:https://documenter.getpostman.com/view/437937/smart-cosmos-objects-devkit-tutorial/2JvFAy[Postman SMART COSMOS Objects DevKit Tutorial^] is a public Postman collection that can be
...
. Open the link:https://documenter.getpostman.com/view/437937/smart-cosmos-objects-devkit-tutorial/2JvFAy[Postman SMART COSMOS Objects DevKit Tutorial^].
...
you can begin to use the SMART COSMOS Objects system you will need to have a valid, active
...
By now we hope you have a much deeper understanding of how the Objects DevKit API works.  Be sure to check back frequently or when you have questions.  The Postman
