...
|Interactions|https://api.smartcosmos.net/microservices/smartcosmos-ext-interactions/index.html[API]|https://github.com/SMARTRACTECHNOLOGY/smartcosmos-devkit/blob/master/config/smartcosmos-ext-interactions.yml[smartcosmos-ext-interactions.yml]| Microservice which provides Interactions logic
